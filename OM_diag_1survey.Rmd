...
repfile <- "inputs/test/hydra_sim.rep"
...
# Graficar la mortalidad total por año para cada especie
ggplot((total_M) , aes(x = year, y = total, color = as.factor(species), group = species)) +
  geom_line(size = 1) + 
  geom_point(size = 2) +
  labs(title = "M2 by year and specie",
       x = "year",
       y = "M2",
       color = "species") +
  theme_minimal() +
  theme(legend.position = "none") + 
  facet_wrap(~ species, scales = "free_y")  # Crear un panel por especie
```
